...
public class DrugInterpreted implements Serializable {
    ...
    public ActiveSubstanceInterpreted addIActivesubstanceinterpreted(
            ActiveSubstanceInterpreted IActivesubstanceinterpreted) {
    ...
    public ActiveSubstanceInterpreted removeIActivesubstanceinterpreted(
            ActiveSubstanceInterpreted IActivesubstanceinterpreted) {
