...
public class Safetyreport implements Serializable {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Clusterduplicate }
     * 
     * 
     */
    public List<Clusterduplicate> getClusterduplicate() {
        if (clusterduplicate == null) {
            clusterduplicate = new ArrayList<Clusterduplicate>();
        }
        return this.clusterduplicate;
    }
