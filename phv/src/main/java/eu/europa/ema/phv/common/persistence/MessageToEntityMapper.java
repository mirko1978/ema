    ...
    public InboundMessageEntity mapMessageToEntity(Exchange exchange, IchicsrMessage icsr) throws Exception {
        ...
        if (icsr.getSenderid() == null ||
            ...
            LOG.error(
                    ...
                    icsr.getSenderid(), icsr.getMessagedate()); //throw exception to rollback?
            throw new InvalidMessageHeaderException(
                    "Message not persisted as the mandatory icsr message headers have invalid value");
        }
        ...
        entity.setDoctype(icsr.getDocumenttype());
        ...
        try {
            ...
            LOG.warn("Message Box for the receiver= {} not available, new one will be created",
                    icsr.getReceiverid()); //no data found exception
